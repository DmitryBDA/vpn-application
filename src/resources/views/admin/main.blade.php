...
<head>
    ...
    <link rel="preload" href="{{ asset('./adm/css/adminlte.css') }}" as="style" />
            ...
            <ul class="navbar-nav ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img
                                            src="{{ asset('./adm/assets/img/user1-128x128.jpg') }}"
                                            alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img
                                            src="{{ asset('./adm/assets/img/user8-128x128.jpg') }}"
                                            alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3"
                                    />
                                </div>
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img
                                            src="{{ asset('./adm/assets/img/user3-128x128.jpg') }}"
                                            alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3"
                                    />
                                </div>
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img
                                src="{{ asset('./adm/assets/img/user2-160x160.jpg') }}"
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
            ...
            <a href="./index.html" class="brand-link">
                <!--begin::Brand Image-->
                <img
                        src="{{ asset('./adm/assets/img/AdminLTELogo.png') }}"
                        alt="AdminLTE Logo"
                                ...
                                <small class="contacts-list-date float-end"> 2/28/2023 </small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img
                                                        class="contacts-list-img"
                                                        src="{{ asset('./adm/assets/img/user7-128x128.jpg') }}"
                                                        alt="User Avatar"
                                                />
                                ...
                                <small class="contacts-list-date float-end"> 2/20/2023 </small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img
                                                        class="contacts-list-img"
                                                        src="{{ asset('./adm/assets/img/user5-128x128.jpg') }}"
                                                        alt="User Avatar"
                                                />
                                ...
                                <small class="contacts-list-date float-end"> 2/10/2023 </small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img
                                                        class="contacts-list-img"
                                                        src="{{ asset('./adm/assets/img/user6-128x128.jpg') }}"
                                                        alt="User Avatar"
                                                />
...
<script src="{{ asset('./adm/js/adminlte.js') }}"></script>
